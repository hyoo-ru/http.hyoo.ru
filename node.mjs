...
;
	($.$hyoo_http) = class $hyoo_http extends ($.$mol_page) {
		Theme(){
		...
		Source_link(){
			...
			(obj.uri) = () => ("https://github.com/hyoo-ru/http.hyoo.ru");
			return obj;
		}
		submit(next){
			if(next !== undefined) return next;
		...
		uri_hint(){
			return (this.$.$mol_locale.text("$hyoo_http_uri_hint"));
		}
		Uri_input(){
		...
		Main(){
			...
			(obj.sub) = () => ([(this.Run()), (this.Uri_input())]);
			return obj;
		}
		request_method_title(){
			return (this.$.$mol_locale.text("$hyoo_http_request_method_title"));
		}
		method(next){
			if(next !== undefined) return next;
			return "get";
		}
		Request_method_input(){
			const obj = new this.$.$mol_switch();
			(obj.value) = (next) => ((this.method(next)));
			(obj.options) = () => ({
				"get": "GET", 
				"head": "HEAD", 
				"options": "OPTIONS", 
		...
		Request_method(){
			...
			(obj.title) = () => ((this.request_method_title()));
			(obj.Content) = () => ((this.Request_method_input()));
			return obj;
		}
		request_headers_title(){
			return (this.$.$mol_locale.text("$hyoo_http_request_headers_title"));
		}
		...
		Request_headers_input(){
			...
			(obj.value) = (next) => ((this.request_headers(next)));
			(obj.submit) = (next) => ((this.submit(next)));
			return obj;
		}
		Request_headers(){
		...
		request_body_title(){
			return (this.$.$mol_locale.text("$hyoo_http_request_body_title"));
		}
		request_body(next){
			if(next !== undefined) return next;
			return "";
		...
		Request_body_input(){
			const obj = new this.$.$mol_textarea();
			(obj.value) = (next) => ((this.request_body(next)));
			(obj.submit) = (next) => ((this.submit(next)));
			return obj;
		}
		Request_body(){
		...
		Request(){
			const obj = new this.$.$mol_scroll();
			(obj.sub) = () => ([(this.Request_locks())]);
			return obj;
		}
		response_headers_title(){
			return (this.$.$mol_locale.text("$hyoo_http_response_headers_title"));
		}
		response_headers(){
			return "";
		}
		Response_headers_output(){
			const obj = new this.$.$mol_text_code();
			(obj.text) = () => ((this.response_headers()));
			return obj;
		}
		Response_headers(){
			const obj = new this.$.$mol_labeler();
		...
		response_body_title(){
			return (this.$.$mol_locale.text("$hyoo_http_response_body_title"));
		}
		response_body(){
			return "";
		}
		...
		body(){
			return [(this.Main()), (this.Data())];
		}
		Response_error(id){
			const obj = new this.$.$mol_status();
			(obj.message) = () => ((this.response_error(id)));
			return obj;
		}
	};
	($mol_mem(($.$hyoo_http.prototype), "Theme"));
	($mol_mem(($.$hyoo_http.prototype), "Lights"));
	($mol_mem(($.$hyoo_http.prototype), "Source_link"));
	($mol_mem(($.$hyoo_http.prototype), "submit"));
	($mol_mem(($.$hyoo_http.prototype), "Run_icon"));
	($mol_mem(($.$hyoo_http.prototype), "Run"));
	($mol_mem(($.$hyoo_http.prototype), "uri"));
	($mol_mem(($.$hyoo_http.prototype), "Uri_input"));
	($mol_mem(($.$hyoo_http.prototype), "Main"));
	($mol_mem(($.$hyoo_http.prototype), "method"));
	($mol_mem(($.$hyoo_http.prototype), "Request_method_input"));
	($mol_mem(($.$hyoo_http.prototype), "Request_method"));
	($mol_mem(($.$hyoo_http.prototype), "request_headers"));
	($mol_mem(($.$hyoo_http.prototype), "Request_headers_input"));
	($mol_mem(($.$hyoo_http.prototype), "Request_headers"));
	($mol_mem(($.$hyoo_http.prototype), "request_body"));
	($mol_mem(($.$hyoo_http.prototype), "Request_body_input"));
	($mol_mem(($.$hyoo_http.prototype), "Request_body"));
	($mol_mem(($.$hyoo_http.prototype), "Request_locks"));
	($mol_mem(($.$hyoo_http.prototype), "Request"));
	($mol_mem(($.$hyoo_http.prototype), "Response_headers_output"));
	($mol_mem(($.$hyoo_http.prototype), "Response_headers"));
	($mol_mem(($.$hyoo_http.prototype), "Response_body_output"));
	($mol_mem(($.$hyoo_http.prototype), "Response_body"));
	($mol_mem(($.$hyoo_http.prototype), "Response_blocks"));
	($mol_mem(($.$hyoo_http.prototype), "Response"));
	($mol_mem(($.$hyoo_http.prototype), "Data"));
	($mol_mem_key(($.$hyoo_http.prototype), "Response_error"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_http.prototype, "request_params", null);
        __decorate([
            $mol_mem
        ], $hyoo_http.prototype, "response", null);
        __decorate([
            $mol_mem
        ], $hyoo_http.prototype, "response_headers", null);
        __decorate([
            $mol_mem
